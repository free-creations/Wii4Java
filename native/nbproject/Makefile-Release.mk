...
LDLIBSOPTIONS=`pkg-config --libs bluez` -lcwiid  
...
${OBJECTDIR}/wiiNative.o: nbproject/Makefile-${CND_CONF}.mk wiiNative.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I${JNI_INCLUDE_OS} -I${JNI_INCLUDE_BASE} `pkg-config --cflags bluez` -std=c++11  -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/wiiNative.o wiiNative.cpp
